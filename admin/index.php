...
<head>
    ...
    <title>Website Admin - BobaShop</title>
    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="index.php"><i class="ti-dashboard"></i><span>Dashboard BobaShop</span></a></li>
							<li><a href="../"><i class="ti-home"></i><span>FrontEnd BobaShop</span></a></li>
							<li>
                                <a href="manageorder.php"><i class="ti-email"></i><span>Kelola Pesanan</span></a>
                            </li>
							<li>
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i><span>List User
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="customer.php">List Pembeli</a></li>
                                    <li><a href="user.php">List Penjual</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    Selamat Bergabung <strong><?php echo $_SESSION['name'] ?></strong>
									<br>
        ...
        <footer>
            <div class="footer-area">
                <p>Copyright &copy; 2022  <a href="#">PONSIANUS JOPI</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
