...
<html>
<head>
<title>Beranda - Boba Shopping</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					echo '
					<li style="color:white">Welcome, '.$_SESSION["name"].'
					<li><a href="logout.php">Logout</a></li>
					';
					};
			...
			<div class="product_list_header">  
					<a href="cart.php"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
					 ...
					 <a href="admin"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-fire" aria-hidden="true"></i></button>
					 </a>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Call Center : +6282150040132</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">BOBA SHOPPING</a></h1>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/hmm3.jpg" alt="" />
			</li>
			<li>
				<img src="images/hmm2.jpg" alt="" />
			</li>
			
			<li>
				<img src="images/hmm4.jpg" alt="" />
			</li>
			<li>
				<img src="images/hmm1.jpg" alt="" />
			</li>
		</ul>
		</ul>
	<!-- //main-slider -->
									...
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												<img src="images/of.png" alt=" " class="img-responsive" />
											</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Boba, Ketapang.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="ponzzy22@gmail.com">ponzzy22@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 8215 0040 132</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Ponsianus Jopi. All rights reserved</p>
			</div>
		</div>
